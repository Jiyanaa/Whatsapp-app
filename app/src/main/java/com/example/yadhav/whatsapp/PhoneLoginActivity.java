...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SendVerificationCodeButton = (Button) findViewById(R.id.send_var_button_code);
        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    loadingBar.setMessage("Please wait, while authenticating your phone number...");
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    loadingBar.setMessage("Please wait, while authenticating verification code...");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
